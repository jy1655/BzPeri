				...
				.gattServiceBegin("device", "180A")
					...
					.gattCharacteristicBegin("mfgr_name", "2A29", {"read"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							self.methodReturnValue(invocation, "Acme Inc.", true);
						})
					...
					.gattCharacteristicBegin("model_num", "2A24", {"read"})
						...
						//
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							self.methodReturnValue(invocation, "Marvin-PA", true);
						})
				...
				.gattServiceBegin("battery", "180F")
					...
					.gattCharacteristicBegin("level", "2A19", {"read", "notify"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							self.methodReturnValue(invocation, batteryLevel, true);
						})
						...
						.onUpdatedValue([](const GattCharacteristic& self, DBusConnectionRef connection, void*) {
							uint8_t batteryLevel = self.getDataValue<uint8_t>("battery/level", 0);
							self.sendChangeNotificationValue(connection, batteryLevel);
							return true;
						})
					...
					.gattCharacteristicBegin("current_time", "2A2B", {"read"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							if (nullptr == pTimeStruct)
							{
								...
								self.methodReturnValue(invocation, std::vector<uint8_t>{}, true);
								return;
							}
							...
							self.methodReturnValue(invocation, payload, true);
						})
				...
				.gattServiceBegin("text", "00000001-1E3C-FAD4-74E2-97A033F1BFAA")
					...
					.gattCharacteristicBegin("string", "00000002-1E3C-FAD4-74E2-97A033F1BFAA", {"read", "write", "notify"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							self.methodReturnValue(invocation, pString, true);
						})
						...
						//
						.onWriteValue([](const GattCharacteristic& self, DBusConnectionRef connection, const std::string&, DBusVariantRef parameters, DBusMethodInvocationRef invocation, void* pUserData) {
							// Extract the byte array from the D-Bus parameters
							// BLE write operations send data as byte arrays
							GVariant* pAyBuffer = g_variant_get_child_value(parameters.get(), 0);
							...
							self.callOnUpdatedValue(connection, pUserData);

							// Send success response back to the client
							self.methodReturnVariant(invocation, DBusVariantRef());
						})
						...
						.onUpdatedValue([](const GattCharacteristic& self, DBusConnectionRef connection, void*) {
							...
							self.sendChangeNotificationValue(connection, pValue);
							return true;
						})
						...
						.gattDescriptorBegin("description", "2901", {"read"})
							...
							//
							.onReadValue([](const GattDescriptor& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
								const char *pDescription = "A mutable text string used for testing. Read and write to me, it tickles!";
								self.methodReturnValue(invocation, pDescription, true);
							})
				...
				.gattServiceBegin("ascii_time", "00000001-1E3D-FAD4-74E2-97A033F1BFEE")
					...
					.gattCharacteristicBegin("string", "00000002-1E3D-FAD4-74E2-97A033F1BFEE", {"read"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							self.methodReturnValue(invocation, timeString, true);
						})
				...
				.gattServiceBegin("cpu", "0000B001-1E3D-FAD4-74E2-97A033F1BFEE")
					...
					.gattCharacteristicBegin("count", "0000B002-1E3D-FAD4-74E2-97A033F1BFEE", {"read"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							self.methodReturnValue(invocation, cpuCount, true);
						})
					...
					.gattCharacteristicBegin("model", "0000B003-1E3D-FAD4-74E2-97A033F1BFEE", {"read"})
						...
						.onReadValue([](const GattCharacteristic& self, DBusConnectionRef, const std::string&, DBusVariantRef, DBusMethodInvocationRef invocation, void*) {
							...
							self.methodReturnValue(invocation, ServerUtils::getCpuInfo(cpuCount), true);
						})
